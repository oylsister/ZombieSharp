...
//public class Events123(ZombieSharp core, Infect infect, GameSettings settings, Classes classes, Weapons weapons, ILogger<ZombieSharp> logger)
//{
...
//    {
//        _core.RegisterAllListeners();
//        //_core.RegisterAllEventHandlers();
